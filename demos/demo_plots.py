...
from enbios.base.plot_experiment import bar_plot, stacked_bar_plot
...
bar_plot(exp, scenarios=["scenario 1", "scenario 2"], image_file=base_plot_destination_path / "bar_plot_2.png")

bar_plot(exp, methods=["bw.GWP1000"], image_file=base_plot_destination_path / "bar_plot_3.png")
...
stacked_bar_plot(exp, level=2, image_file=base_plot_destination_path / "stacked_plot_2.png")
