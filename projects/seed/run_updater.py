...
for scen in scenarios:
    ...
    path_save_csv=r'C:\Users\Administrator\PycharmProjects\enbios2\projects\seed\MixUpdater\results' + '/'+str(scen)+'.csv'
    path_save_json=r'C:\Users\Administrator\PycharmProjects\enbios2\projects\seed\MixUpdater\results' + '/'+str(scen)+'.json'
