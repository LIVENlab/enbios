...
def solve_bioflows(lca: LCA) -> list[tuple[ActivityDataset, float]]:
    ...
    biosphere_activities = list(ActivityDataset.select().where(ActivityDataset.id.in_(list(lca.dicts.biosphere.keys()))))
...
def solved_bioflow2csv(solved_bioflow: list[tuple[ActivityDataset, float]], file_path: str):
